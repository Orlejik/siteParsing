...
//    }
    ...
    public static void main(String[] args) {
        ...
        double sizeX = screenSize.getWidth();
        double sizeY = screenSize.getHeight();

        int dimX = 1500;
        int dimY = 30;

        System.out.printf("Size X is : %f, and dimention X is : %d. The difference is : %f \n", sizeX,dimX, sizeX-dimX);
        System.out.printf("Size Y is : %f, and dimention Y is : %d. The difference is : %f", sizeY,dimY, sizeY-dimY);
    }
